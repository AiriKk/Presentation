...
class CountAdapter (private val activity: Activity, private val items: Array<Pair<String,Int>>) : BaseAdapter() {
    private class ViewHolder(row: View) {
        val wordTextView = row.findViewById(R.id.wordBox) as TextView
        val countTextView  = row.findViewById(R.id.countBox) as TextView
    }
